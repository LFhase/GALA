...
class Mutag(InMemoryDataset):
    ...
    def download(self):
        if not osp.exists(osp.join(self.raw_dir, 'Mutagenicity.pkl')):
            print(f"raw data of `Mutagenicity` doesn't exist {osp.join(self.raw_dir,'Mutagenicity.pkl')}, please redownload from our github.")
